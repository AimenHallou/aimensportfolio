  ...
  projects = [
    {
      title: 'MedChain',
      description:
        'Leading the development of a blockchain-based system for secure patient-doctor data sharing.',
      skills: [
        'React',
        'Tailwind CSS',
        'Node.js',
    ...
    },
    {
      title: 'Pet Connect',
      description:
        'Crafting a social media application for pets, enhancing community engagement among pet owners.',
      skills: [
        'React Native CLI',
        'TypeScript',
        'Express',
    ...
    },
    {
      ...
      description:
        'Developing a comprehensive blockchain game with NFT storage and smart contract functionality.',
      skills: [
        'Solidity',
        'Node.js',
        'Next.js',
